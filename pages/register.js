              ...
              <div className="col-sm-3 col-md-4">
                <form onSubmit={this.registerUser}>
                  <div className="form-group">
                    ...
                    <select name="brand" className="form-control" id="brand" required>
                  ...
                  <div className="form-group">
                    ...
                    <select name="post" className="form-control" id="post" required>
                  ...
                  <div className="form-group">
                    <label htmlFor="post">Choose ASM(If Required)</label>
                    <select name="asm" className="form-control" id="asm">
                  ...
                  <div className="form-group">
                    ...
                    <input type="tel" name="mobile" maxLength="10" pattern="[0-9]{10}" className="form-control" id="mobile" required/>
                  </div>
                  <div className="form-group">
                    <label htmlFor="email">Company Email address:</label>
                    <input type="email" name="email" placeholder="Official Email"  className="form-control" id="email" />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="row">
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        <label htmlFor="state">Your Area of Operation - States</label>
                        <ul className="list-group list" style={{ height: 200, overflow: 'scroll' }}>                       
                          {options.map((o, index) => (
                            <li key={o} className="list-group-item">
                              <input type="checkbox" name="allStates" value={o} className="form-check-input statecheck" id={`${index}_state`} onChange={this.handleInputChange} />
                              <label className="form-check-label" htmlFor={`${index}_state`}>{o}</label>
                            </li>
                          ))}
                        </ul>
                      </div>
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="form-group">
                        ...
                        <ul className="list-group" style={{ height: 200,overflow: 'scroll' }}>
                          <li key="selectall" className="list-group-item">
                            <input type="checkbox" name="selectall" value="all" className="form-check-input" id="selectall"  onChange={this.handleInputChange} />
                            <label className="form-check-label" htmlFor="selectall">Select All</label>
                          </li>
                          {allStates.map((o, index) => (
                            cityMaps[o].map((sho, indexv) => (
                              <li key={sho} className="list-group-item">
                                <input type="checkbox" name="allCities" value={sho} className="form-check-input citycheck" id={`${indexv}_city`} onChange={this.handleInputChange} />
                                <label className="form-check-label" htmlFor={`${indexv}_city`}>{sho}</label>
                              </li>
                            ))
                          ))}
                        </ul>
