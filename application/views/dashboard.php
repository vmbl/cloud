<?php
  ...
  $allStates = json_decode($lookup);
//echo json_encode($lookup);
//print_r(json_decode($cities));
//exit();
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-tachometer" aria-hidden="true"></i> LivSol 360
        <small>Account Registration</small>
      </h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
              <div class="col-sm-8">
                <form action="<?=base_url() ?>user/register" method="post" id="regform">
                    ...
                    <div class="form-group">
                      <label for="asm">Choose ASM :</label>
                    ...
                    <div class="form-group">
                       ...
                       <input type="tel" name="mobile" maxLength="10" pattern="[0-9]{10}" class="form-control" id="mobile">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="states">Your Area of Operation - States</label>
                        <ul class="list-group list" style="height: 200px; overflow: scroll;">   
                          <?php 
                              //print_r($allStates); 
                              foreach ($allStates->states as $key => $value) { ?>
                                <li key="<?=$key?>" class="list-group-item">
                                  <input type="checkbox"  id="states_<?=$key?>" class="allst" name="allStates[]" value="<?=$value?>" />
                                  <label for="states_<?=$key?>" class="form-check-label"><?php echo $value ?></label>
                                </li>
                          <?php } ?>                    
                        </ul>                       
                    </div>
                    <div class="form-group">
                       <label for="cities">Your Area of Operation - Cities</label>
                        <ul class="list-group list" id="cities" style="height: 200px; overflow: scroll;">   
                                            
                        </ul>
                    </div>

                    <button type="submit" class="btn btn-xl btn-danger">Submit</button>
                </form> 
              </div>
          </div>
    </section>
  ...
  jQuery(document).ready(function(){
      ...
      $("#post").change(function(){
       ...
       /*$("form#regform").submit(function(e){
          ...
          $("input:checkbox[class=allct]:checked").each(function(){
             checkcity = true;
          });

          alert(checkcity)
          alert(checkstate)
          if(!checkcity) { alert("Please select city"); return false }
          if(!checkstate) { alert("Please select state"); return false }
